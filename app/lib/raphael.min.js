...
(function(a) {
    ...
    function() {
        ...
        function cq() {
            return this.x + q + this.y + q + this.width + " 锟� " + this.height
        }
        function cp() {
                ...
                for (var q = 0; q < j; q++) {
                    ...
                    if (x) {
                        if (m[x.x.toFixed(4)] == x.y.toFixed(4))
                            continue;m[x.x.toFixed(4)] = x.y.toFixed(4);
            ...
            if (k) {
                ...
                if (k[5]) {
                    ...
                    j[1].slice(-1) == "%" && (e *= 2.55),
                        f = Q(j[2]),
                    j[2].slice(-1) == "%" && (f *= 2.55),
                    (j[0].slice(-3) == "deg" || j[0].slice(-1) == "锟�") && (d /= 360),
        ...
        a.findDotsAtSegment = function(a, b, c, d, e, f, g, h, i) {
            ...
            a._removedFactory = function(a) {
                return function() {
                    eve("raphael.log", null , "Rapha锟絣: you are calling to method 锟�" + a + "锟� of removed object", a)
                }
            }
        ;
            ...
            , cA = function() {
                ...
                for (; c < cy.length; c++) {
                    ...
                    if (d.el.removed || d.paused)
                        continue;var e = b - d.start, f = d.ms, h = d.easing, i = d.from, j = d.diff, k = d.to, l = d.t, m = d.el, o = {}, p, r = {}, s;
...
window.Raphael.svg && function(a) {
    var b = "hasOwnProperty"
        ...
        , p = {};
    a.toString = function() {
        return "Your browser supports SVG.\nYou are running Rapha锟絣 " + this.version
    }
    ;
    var q = function(d, e) {
            if (e) {
    ...
    z.prototype = A,
        ...
        a.prototype.clear = function() {
            ...
            this.bottom = this.top = null ,
                (this.desc = q("desc")).appendChild(a._g.doc.createTextNode("Created with Rapha锟絣 " + a.version)),
...
window.Raphael.vml && function(a) {
    var b = "hasOwnProperty"
        ...
        ;
    a.toString = function() {
        return "Your browser doesn锟絫 support SVG. Falling down to VML.\nYou are running Rapha锟絣 " + this.version
    }
    ;
